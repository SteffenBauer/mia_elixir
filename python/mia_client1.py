...
LOCALIP = '127.0.0.2'
LOCALPORT = 4082
LOCALNAME = "PROBABILISTIC_PLAYER"
...
def connect_to_miaserver(sock):
  sock.settimeout(2)
  while True:
    sock.sendto("REGISTER_PLAYER;" + LOCALNAME, (SERVERHOST, SERVERPORT))
    try:
      data = sock.recv(1024)
